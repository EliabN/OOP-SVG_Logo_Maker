...
function createLogo(logo = []) {
    ...
    function renderShape(shape) {
        ...
        const shapes = {
            ...
            <circle cx="150" cy="100" r="80" stroke="black" stroke-width="4" fill="green" />
          
            <text x="150" y="120" font-size="60" text-anchor="middle" fill="white">${logo[0].text}</text>
