...
class Square extends Shape {
    ...
    render() {
        //console.log(logoAnswers.text)
        return `<rect x="50" y="20" width="150" height="150" stroke-width="4" fill="${this.shapeColor}" stroke="black" />
...
class Rectangle extends Shape {
    ...
    render() {
        //console.log(logoAnswers.text)
        return `<rect x="50" y="20" width="300" height="150" stroke-width="4" fill="${this.shapeColor}" stroke="black" />
        \n\t<text x="200" y="115" font-size="60" text-anchor="middle" fill="${this.textColor}">${this.text}</text>`;
    }
}
